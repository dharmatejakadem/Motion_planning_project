...
if __name__ == "__main__":
	...
	with env:
		...
		ShortCutIters = 200;
		startTime = time.time()
		#Please note that this is set. Means it runs bidirectional RRT
		biRRTFlag =1; # 0 for unidirectional RRT. To run bidirectional RRT set this flag to 1

		path = RRTmodule.SendCommand('RRT goal %f,%f,%f,%f,%f,%f,%f; goalBias 0.1; step %f; metricWeight 900,800,60,25,0,13,0; shortCutStep 0; shortIters %f; biRRTFlag %f;'%tuple(goalconfig+[stepSize,ShortCutIters,biRRTFlag]))
